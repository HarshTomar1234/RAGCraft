...
# ============================================================
# 2. CLAUDE JUDGE (replaces gpt-4o-mini)
# ============================================================
...
# 6B. PII leakage. Custom GEval (replaces broken PIILeakageMetric).
# Built-in metric extracts PII-shaped words from refusals with zero context.
...
# Custom GEval (replaces broken ToxicityMetric). Built-in metric flagged correct
# refusals ("I won't write that — it's disrespectful") as toxic.
